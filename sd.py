...
check_xpath_first = '/html/body/div[4]/div/div[1]/div[3]/div[1]/form/div[3]/fieldset/section[1]/div[2]/div[4]/div/div'
...
link_xpath = ('/html/body/div[4]/div/div[1]/div[3]/div[1]/form/div[3]/fieldset/'
              'section[1]/div[3]/div[5]/div/div[1]/div[6]/div[3]/div/a')
...
for i in range(pages_num):
    ...
    for link in (driver.find_element(By.CLASS_NAME, 'esz-result-sections').find_elements(By.XPATH, './/a')):
        links_lst.append(link.get_attribute('href'))
    # for name in names:
    #     print(name.find_element(By.CLASS_NAME, 'esz-result-sections'))
    #     print()
    #     print()
    #     print()
    for link in links_lst[1::2]:
        print(link)
    print()
    print()
    if i != pages_num - 1:
